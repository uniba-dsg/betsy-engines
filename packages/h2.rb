...
package :h2_tomcat_db do
  ...
  runner [
    "cp ./#{getH2DBVersion()} /usr/share/tomcat7/lib/#{getH2DBVersion()}",
    "chmod 777 /usr/share/tomcat7/lib/#{getH2DBVersion()}"]
...
package :h2_tomcat_db_download do
  ...
  runner "wget --no-check-certificate https://svn.lspi.wiai.uni-bamberg.de/svn/betsy/#{getH2DBVersion()}"
